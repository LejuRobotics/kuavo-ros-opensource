...
- 新增五代 AMP 步态模型，支持基础行走、上肢 VR 控制、左右 30° 转腰和全向抗扰，优化转向时的速度补偿和脚跟着地效果
- 新增 Roban2.2 版本机器人型号，优化脚踝运动解算并添加 pitch 偏移补偿，完善太极动作和楼梯功能
...
- 统一多个机器人型号的 URDF 和 XML 模型文件，确保 MPC 和 RL 控制器行为一致
