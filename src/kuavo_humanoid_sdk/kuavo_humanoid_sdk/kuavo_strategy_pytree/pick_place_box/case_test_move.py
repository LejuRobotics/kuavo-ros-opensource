...
from kuavo_humanoid_sdk.kuavo_strategy_pytree.nodes.nodes import NodeFuntion, NodeDelay, NodeWalk, NodePercep
...
def main():
    parser = argparse.ArgumentParser(description="PyTree移动示例：使用NodeWalk节点")
    parser.add_argument(
        "--control-mode",
