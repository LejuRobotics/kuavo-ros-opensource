...
blackboard_json = "/root/kuavo_ws/kuavo50/kuavo-ros-control/src/pytrees_actions/board_des.json"
# 全局实例用于兼容现有代码调用
...
def main():
    ...
    tree_json_file = "/root/kuavo_ws/kuavo50/kuavo-ros-control/src/pytrees_actions/py_tree_depalletize_lb.json"
