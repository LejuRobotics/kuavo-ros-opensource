...
def send_interpolated_motion(leg_start, arm_start, leg_end, arm_end, total_time, num_steps=50):
    ...
    for i in range(num_steps):
        ...
        ct.send_timed_multi_commands(timed_cmd_vec=timed_cmd_vec, is_sync=True, verbose=False)
...
def execute_leg_tests():
    ...
    test_cases = [
        ...
        # 帧3
        ("帧3", 2.0, 
         [40.0, -100.0, 40.0, 175.0],  # 下肢角度
         [85.0, 60.0, 45.0, -110.0, 80.0, 25.0, 25.0, 85.0, -60.0, -45.0, -110.0, -80.0, -25.0, 25.0]),
        
        # 帧4
        ("帧4", 2.5, 
         [70.0, -142.0, 70.0, 0.0],  # 下肢角度
