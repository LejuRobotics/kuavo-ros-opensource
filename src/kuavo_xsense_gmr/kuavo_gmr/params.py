...
ROBOT_XML_DICT = {
    ...
    "kuavo_s54": ASSET_ROOT / "biped_s54" / "biped_s54.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "bvh_lafan1":{
        ...
        "kuavo_s52": IK_CONFIG_ROOT / "bvh_lafan1_to_kuavo_s52.json",
    },
    "bvh_nokov":{
        "unitree_g1": IK_CONFIG_ROOT / "bvh_nokov_to_g1.json",
    },
    "bvh_motive_bj":{
        "kuavo_s52": IK_CONFIG_ROOT / "bvh_motive_to_kuavo_s52.json",
    },
    "bvh_motive_sz":{
        "kuavo_s52": IK_CONFIG_ROOT / "bvh_motive_to_kuavo_s52.json",
    },
    "bvh_motive_streaming":{
        "kuavo_s52": IK_CONFIG_ROOT / "pico_to_kuavo.json",
    },
    "bvh_xsense":{
        "kuavo_s54": IK_CONFIG_ROOT / "xsense_to_kuavo.json",
    },
    "fbx":{
