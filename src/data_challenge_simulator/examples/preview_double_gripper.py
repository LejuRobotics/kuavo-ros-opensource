#!/usr/bin/env python3
"""Preview one canonical double-gripper closure in the current MuJoCo model."""
...
from utils.hand_postures import double_gripper_pose
...
def main():
    ...
    parser.add_argument(
        ...
        help="Normalized double-gripper closure: 0=open, 1=closed")
    parser.add_argument(
    ...
    poses = {side: double_gripper_pose(args.closure, side) for side in sides}
