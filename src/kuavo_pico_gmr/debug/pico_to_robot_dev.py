...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pico_file",
        help="Pico motion file to load.",
        default="pico_data/pico_data_ori.csv",
        type=str,
    )

    parser.add_argument(
        "--format",
        choices=["lafan1", "nokov", "pico"],
        default="pico",
    )
    ...
    parser.add_argument(
        "--robot",
        choices=["unitree_g1", "unitree_g1_with_hands", "kuavo_s45"],
        default="kuavo_s45",
    )
    ...
    pico_data_frames, actual_human_height, _ = load_pico_file(args.pico_file)
    
    # Initialize the retargeting system
    retargeter = GMR(
        src_human=args.format,
