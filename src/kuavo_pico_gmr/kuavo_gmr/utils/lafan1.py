...
from kuavo_gmr.utils.lafan_vendor.extract import read_bvh
...
def load_bvh_file(bvh_file, format="lafan1"):
    ...
    for frame in range(data.pos.shape[0]):
        ...
        # In the LAFAN dataset, the foot orientation and toe orientation are different.
        # In the Robot Ontology, the foot orientation and toe orientation are the same.
        # Therefore, we need to modify the foot orientation and toe orientation to be the same.
        if format == "lafan1":
