...
class TagViewer(QMainWindow):
    def __init__(self):
        ...
        ros_env.init_node('tag_viewer', anonymous=True)
        self.tag_subscriber = ros_env.Subscriber('/detected_tags', AprilTagDetectionArray, self.tag_callback, queue_size=10)
...
def main():
    try:
        ...
        viewer.show()
        sys.exit(app.exec_())
    except ros_env.ROSInterruptException:
        pass
