...
class VoiceCoordinator:
    ...
    def __init__(self, subscribe_topic="/micphone_data"):
        ...
        vad_chunk_size_ms = 200 # VAD每次处理的音频时长(ms)
        ...
        self.vad_process = multiprocessing.Process(
            ...
            args=(self.audio_queue, self.speech_queue, self.vad_config, self.shutdown_event),
            name="VAD-Process",
        ...
        self.asr_process = multiprocessing.Process(
            ...
            args=(self.speech_queue, self.result_queue, self.asr_config, self.shutdown_event),
            name="ASR-Process",
            daemon=True
        )
    ...
    def _init_hot_word_from_keyword(self, keyword_to_action):
        ...
        hot_words = list(keyword_to_action.keys())
