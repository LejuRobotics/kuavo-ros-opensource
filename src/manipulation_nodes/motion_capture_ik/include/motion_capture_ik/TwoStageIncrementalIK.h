...
class TwoStageIncrementalIK : public BaseIncrementalIKSolver {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  explicit TwoStageIncrementalIK(drake::multibody::MultibodyPlant<double>* plant,
                                 const std::vector<std::string>& ikConstraintFrameNames,
                                 const IKSolverConfig& config);

  ~TwoStageIncrementalIK() = default;
