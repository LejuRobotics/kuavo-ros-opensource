        ...
        #     break  
            ...
            if robot_version:
                try:
                    ...
                    if version_num == 62 or version_num == 63:
                        ...
                        print(bcolors.WARNING + f"警告：版本 {robot_version} 不在支持的范围内（13-14、17、40-49、50-52、53、62-63），当前不支持自动选择磨线脚本" + bcolors.ENDC)
            ...
            if kuavo_breakin_script:
                if os.path.exists(kuavo_breakin_script):
                    ...
                    # 询问用户是否已校准零点并位于零点位置
                    if version_num is not None and (version_num == 62 or version_num == 63):
