...
| 参数类别 | 规格参数 | 指标说明 |
|:---:|:---|:---|
| **体型参数** | 身高<br/>体重<br/>单臂臂长<br/>主体结构材质 | 1.66m<br/>55kg<br/>790mm<br/>铝合金、钢材 |
| **自由度** | 全身自由度<br/>关节分布 | 40 个自由度<br/>颈关节 2×1、肩关节 3×2、肘关节 1×2、髋关节 3×2、膝关节 1×2、踝关节 2×2、腕关节 3×2、灵巧手 6×2 |
| **运行参数** | 行走速度 | 能够实现全向行走，速度 2 km/h |
| **电池及续航** | 满电电压<br/>电池容量<br/>换电功能 | 60V<br/>12Ah<br/>支持不关机自主站立换电功能，保证连续工作 |
| **传感器** | 视觉传感器<br/><br/><br/>IMU 精度<br/>陀螺仪<br/>加速度传感器 | 立体视觉相机：<br/>- 景深/红外：60 fps，分辨率 1280×720<br/>- RGB：30 fps，分辨率 1080P<br/>- 支持功能：物体识别、定位和追踪<br/>俯仰/横滚方向 0.15 度，航向角漂移 0.15 度<br/>满量程 2000 度/秒，零偏不稳定性 2.5°/h<br/>满量程 12g，零偏不稳定性 30μg |
| **控制系统** | 运动控制系统<br/>感知交互系统 | 酷睿 i9-13900，内存 64G，硬盘 500G，支持国产化系统且安全可靠<br/>算力 100 Tops |
| **驱动器** | 驱动器参数 | 共 14 个，最大电压 72V，连续电流 50A，峰值电流 70A |
| **核心算法** | 支持算法 | 全向行走步态算法、状态估计算法、运动控制算法、全身力控算法、抗扰动态平衡控制算法、视觉识别算法等 |
| **负载能力** | 单臂负载 | 3kg |
| **功能实现** | 地面适应性 | 不平整地面稳定行走，自适应不平整地面高度 2cm；支持 3D 深度视觉技术 |
| **开发案例** | 落足点规划 | 提供落足点规划案例 |
| **关节协议** | 关节通讯协议 | EtherCAT 总线通讯，控制速率：2KHz |
| **关节扭矩** | 本体最大关节扭矩 | 350Nm |
